...
This repository contains the source code for the official website of **Vaimuaare OÜ**.

## Overview

- **Project Name:** Vaimuaare OÜ homepage
- **Website:** [vaimuaare.github.io](https://vaimuaare.github.io)
- **Author:** Varje Kivila
...
- Image gallery with captions and navigation arrows
- Contact form that submits data to Google Sheets
